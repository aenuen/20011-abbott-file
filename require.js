...
const dataToFile = (fData, fFile) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].writeFile(fFile, fData, (err) => {
...
const deleteFile = (fFile) => {
    return new Promise((resolve, reject) => {
        if (fFile) {
            if (fs__default["default"].existsSync(fFile)) {
                fs__default["default"].unlink(fFile, (err) => {
...
const deleteFolder = (fFolder) => {
    return new Promise((resolve, reject) => {
        if (fs__default["default"].existsSync(fFolder)) {
            fs__default["default"].rmdir(fFolder, { recursive: true }, (err) => {
                err ? reject(false) : resolve(true);
            });
        }
        else {
...
class FileParse {
    ...
    parse() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            if (this.suffix) {
                if (fs__default["default"].existsSync(this.path) && !fs__default["default"].existsSync(this.filePath)) {
                    fs__default["default"].renameSync(this.path, this.filePath);
                }
                resolve(this);
            }
            else {
...
const getStats = (fOrFPath) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].stat(fOrFPath, (err, stats) => {
...
const isExists = (fOrFPath) => {
    return new Promise((resolve, reject) => {
        const result = fs__default["default"].existsSync(fOrFPath);
...
const isFile = (fFile) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].stat(fFile, (err, stats) => {
...
const isFolder = (fFolder) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].stat(fFolder, (err, stats) => {
...
const readDownFile = (folder) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].readdir(folder, (err, files) => {
...
const rename = (fOld, fNew) => {
    return new Promise((resolve, reject) => {
        fs__default["default"].rename(fOld, fNew, (err) => {
            err ? reject(false) : resolve(true);
        });
    });
};
...
exports.readDownFile = readDownFile;
